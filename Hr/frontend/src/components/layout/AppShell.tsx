...
const navItems: NavItem[] = [
  ...
  { to: '/leave', label: 'Leave Tracker', icon: ClipboardCheck, roles: ['CEO', 'HR', 'Manager', 'Lead', 'Employee'] },
  { to: '/hr/leave', label: 'HR Leave Portal', icon: ShieldCheck, roles: ['CEO', 'HR', 'Manager', 'Lead'] },
