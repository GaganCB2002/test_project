      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_2fr]">
        ...
        {selectedEmployee ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-3xl">
            <Folder className="h-12 w-12 text-slate-300 dark:text-slate-600 mb-4" />
            <p className="text-slate-500 dark:text-slate-400 font-medium">Select an employee folder to view details</p>
          </div>
        )}
      </div>
    </div>
