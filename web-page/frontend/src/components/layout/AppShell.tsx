...
const navItems: NavItem[] = [
  ...
  { to: '/manager-dashboard', label: 'Manager Hub', icon: TrendingUp, roles: ['MANAGER', 'CEO'] },
  ...
  { to: '/profile', label: 'My Profile', icon: UserRoundCog, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'MARKETING', 'ADMIN', 'SUPERADMIN'] },
  { to: '/chat', label: 'Live Chat', icon: MessageSquare, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'MARKETING', 'ADMIN', 'SUPERADMIN'] },
  { to: '/mail', label: 'Internal Mail', icon: Mail, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'MARKETING', 'ADMIN', 'SUPERADMIN'] },
  { to: '/meetings', label: 'Video Meetings', icon: Terminal, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'MARKETING', 'ADMIN', 'SUPERADMIN'] },
  { to: '/attendance', label: 'Attendance', icon: TimerReset, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/feed', label: 'Live Activity Feed', icon: Activity, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/recruitment', label: 'Recruitment', icon: BriefcaseBusiness, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/allocation', label: 'Resource Allocation', icon: Layers, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/leave-approvals', label: 'Leave Approvals', icon: FileWarning, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/people', label: 'Employee Mgmt', icon: UsersRound, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/onboarding', label: 'Onboarding', icon: ClipboardCheck, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/documentation', label: 'Documentation', icon: Folder, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/payroll', label: 'Payroll', icon: BadgeIndianRupee, roles: ['CEO', 'HR', 'MANAGER', 'ADMIN', 'SUPERADMIN'] },
  { to: '/performance', label: 'Performance', icon: Gauge, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/projects', label: 'Projects', icon: Activity, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/engagement', label: 'Engagement', icon: SmilePlus, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/compliance', label: 'Compliance', icon: ShieldCheck, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/help-desk', label: 'IT Help Desk', icon: LifeBuoy, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'EMPLOYEE', 'ADMIN', 'SUPERADMIN'] },
  { to: '/exit', label: 'Exit', icon: DoorOpen, roles: ['CEO', 'HR', 'MANAGER', 'ADMIN', 'SUPERADMIN'] },
  { to: '/budget', label: 'Budget', icon: ChartColumn, roles: ['CEO', 'HR', 'ADMIN', 'SUPERADMIN'] },
  { to: '/analytics', label: 'Analytics', icon: Network, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/live-tracking', label: 'Live Tracking', icon: Map, roles: ['CEO', 'HR', 'MANAGER', 'LEAD', 'TECH_LEAD', 'ADMIN', 'SUPERADMIN'] },
  { to: '/marketing-hub', label: 'Marketing Hub', icon: Target, roles: ['MARKETING', 'CEO', 'ADMIN', 'SUPERADMIN'] },
  { to: '/sales', label: 'Sales Pipeline', icon: TrendingUp, roles: ['MARKETING', 'CEO', 'ADMIN', 'SUPERADMIN'] },
  { to: '/ai-insights', label: 'AI Insights', icon: Sparkles, roles: ['MARKETING', 'CEO', 'ADMIN', 'SUPERADMIN'] },
]
